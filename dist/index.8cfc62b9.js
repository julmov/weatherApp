...
parcelHelpers.exportAll(_scriptJs, exports);
...
submitBtn.addEventListener("click", async function() {
    ...
    if (city) try {
        ...
        (0, _canvasJs.myCanvas)(city, weatherData);
...
async function getWeatherData(city) {
    ...
    if (!geoResponse.ok) throw new Error("Could not fetch city data");
...
const createCard = (forecast, index, city)=>{
    ...
    tempDisplay.textContent = `Temperature: ${tempCelsius}\xb0C`; // Display temperature in Celsius as an integer
    ...
    weatherEmoji.textContent = (0, _emojiJs.getWeatherEmoji)(description); // Pass description to getWeatherEmoji function
...
async function displayCityPhoto(cityName) {
    try {
        const unsplashResponse = await fetch(`https://api.unsplash.com/search/photos?page=1&query=${cityName}&client_id=6Zhb8bS8u-t064Jq4aCc7TcIaNYrpi3-pZtG1QywCPA`);
        const unsplashData = await unsplashResponse.json();
        const photoUrl = unsplashData.results[0].urls.regular;
        // Check if cityContainer already exists
        let cityContainer1 = document.querySelector(".city-container");
        cityContainer1.innerHTML = ""; // Clear previous data
        ...
        document.body.style.backgroundImage = `url(${photoUrl})`;
         ...
         document.body.style.backgroundPosition = "center";*/ // Create a div for weather info
        const weatherInfo = document.createElement("div");
        weatherInfo.classList.add("weather-info");
        // Append weather info to the container
        cityContainer1.appendChild(cityPhoto);
        cityContainer1.appendChild(weatherInfo);
...
function displayCityWeatherInfo(weatherData, weatherInfoContainer) {
    ...
    forecasts.forEach((forecast)=>{
        ...
        dateDisplay.textContent = `${month} ${day}`;
        const tempDisplay = document.createElement("p");
        tempDisplay.textContent = `${Math.round(temp - 273.15)}\xb0C`;
        ...
        weatherEmoji.textContent = (0, _emojiJs.getWeatherEmoji)(description);
...
},{"./emoji.js":"fEo9Z","./canvas.js":"15ljZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./script.js":"6rimH"}],"15ljZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "myCanvas", ()=>myCanvas);
parcelHelpers.export(exports, "clearPreviousContent", ()=>clearPreviousContent);
var _scriptJs = require("./script.js");
var _canvasJs = require("./canvas.js");
parcelHelpers.exportAll(_canvasJs, exports);
...
},{"./canvas.js":"15ljZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./script.js":"6rimH"}]},["86oZd","6rimH"], "6rimH", "parcelRequirea848")
